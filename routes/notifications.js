...
router.post("/", isAuth, [
    ...
    oneOf([
        check("scheduledAt").isEmpty().withMessage(__("scheduledAt field shound be empty")),
        check("scheduledAt").isDate().withMessage(__("scheduledAt field shound be a valid date")),
    ], __("Please provide a valid date or empty value to schedule for immediate sending"))
